...
Pre-patched fonts designed for enthusiasts who love to rice their terminal, window manager, and more, featuring over **60k icons** as glyphs for ultimate customization and flair!

![if-text](assets/png/iconicfonts-text.png)

![if-text](assets/png/if-preview.png)
...
| [MonaspaceArgon IF][if-monaspaceargon]                     | [MonaspaceArgon][monaspace-argon]            | `1.101`   | [MonaspaceArgon][preview-monaspaceargon]                     | [ZIP][zip-monaspaceargon]           - [TAR.GZ][tar-monaspaceargon]           |
| [MonaspaceKrypton IF][if-monaspacekrypton]                 | [MonaspaceKrypton][monaspace-krypton]        | `1.101`   | [MonaspaceKrypton][preview-monaspacekrypton]                 | [ZIP][zip-monaspacekrypton]         - [TAR.GZ][tar-monaspacekrypton]         |
| [MonaspaceNeon IF][if-monaspaceneon]                       | [MonaspaceNeon][monaspace-neon]              | `1.101`   | [MonaspaceNeon][preview-monaspaceneon]                       | [ZIP][zip-monaspaceneon]            - [TAR.GZ][tar-monaspaceneon]            |
| [MonaspaceRadon IF][if-monaspaceradon]                     | [MonaspaceRadon][monaspace-radon]            | `1.101`   | [MonaspaceRadon][preview-monaspaceradon]                     | [ZIP][zip-monaspaceradon]           - [TAR.GZ][tar-monaspaceradon]           |
| [MonaspaceXenon IF][if-monaspacexenon]                     | [MonaspaceXenon][monaspace-xenon]            | `1.101`   | [MonaspaceXenon][preview-monaspacexenon]                     | [ZIP][zip-monaspacexenon]           - [TAR.GZ][tar-monaspacexenon]           |
...
![Icon types](assets/png/icon-types.png)
...
![Negative and positive space glyphs](assets/png/negative-and-positive-space-glyphs.png)
...
<p style="text-align:center;">
  <img src="assets/png/search-glyphs.png" alt="Search glyphs" style="max-width:100%; height:auto;" />
</p>
